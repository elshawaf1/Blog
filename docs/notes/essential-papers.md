...
---------------------------------------------------------------
  ...
  7. RoFormer: Rotary Position Embedding (Su et al., 2021)
  ...
  11. Direct Preference Optimization (DPO) (Rafailov et al., 2023)
   > A simpler and more stable alternative to PPO-based RLHF
   > Preference alignment via the loss function

  12. Chain-of-Thought Prompting Elicits Reasoning in Large Language Models (Wei et al., 2022)
  ...
  13. ReAct: Reasoning and Acting (Yao et al., 2022 / ICLR 2023)
   > The foundation of agentic systems
   > Combines reasoning traces with tool use and environment interaction

  14. DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning (Guo et al., 2025)
